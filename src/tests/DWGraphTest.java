...
//        graph_algo.getGraph().removeEdge(0,2);
//        int numOfEdges = 4;
//        int numOfNodes = 5;
...
//        assertEquals(graph_algo.shortestPathDist(3,0),8);
//
...
//
//        assertEquals(graph_algo.shortestPathDist(2,4),11);
...
//        WGraph_DS graphB = new WGraph_DS();
//        for (int i = 0; i < 9; i++)
//            graphB.addNode(i);
//
...
//
//        graph_algo = new WGraph_Algo(graphB);
...
//        assertTrue(graph_algo.isConnected());
//
//        assertEquals(graph_algo.shortestPathDist(1,6),8);
//        List<node_info> copyGraph_sp1to6 = graph_algo.shortestPath(1,6);
//        if (copyGraph_sp1to6 != null)
//            System.out.println(Arrays.toString(copyGraph_sp1to6.toArray()));
//
//        double dist6to1 = graph_algo.shortestPathDist(6,1);
//        System.out.println("shortest path: 6,1 dist = " + dist6to1);
//
//        double dist7to8 = graph_algo.shortestPathDist(7,8);
//        System.out.println("shortest path: 7,8 dist = " + dist7to8);
//        List<node_info> copyGraph_sp7to8 = graph_algo.shortestPath(7,8);
...
//        List<node_info> copyGraph_sp8to7 = graph_algo.shortestPath(8,7);
...
//        List<node_info> myGraph_sp3to6 = graph_algo.shortestPath(3,6);
...
//        List<node_info> myGraph_sp6to3 = graph_algo.shortestPath(6,3);
...
//
//        graph_algo = new WGraph_Algo(graphC);
//        copyGraph = graph_algo.copy();
//        graph_algo.init(copyGraph);
//
//        assertFalse(graph_algo.isConnected());
...
//
//        List<node_info> spSideA = graph_algo.shortestPath(2,3);
//        if (spSideA != null)
//            System.out.println(Arrays.toString(spSideA.toArray()));
//
//        double distSideB = graph_algo.shortestPathDist(0,3);
//        System.out.println("shortest path: 3,2 dist = " + distSideB);
//        List<node_info> spSideB = graph_algo.shortestPath(3,2);
//        if (spSideB != null)
//            System.out.println(Arrays.toString(spSideB.toArray()));
//    }

    public static void createGraphD() {
        DWGraph_DS graphD = new DWGraph_DS();
        for (int i = 0; i < 4; i++){
            NodeData newNode = new NodeData(i);
            graphD.addNode(newNode);
        }

        graphD.connect(0,1,3);
        graphD.connect(1,2,1);
        graphD.connect(2,0,20);
